			...
			const getGroup = async function(totalchat){
				...
				if (authorname != undefined) { } else { authorname = groupName }	
					function addMetadata(packname, author) {	
						if (!packname) packname = 'Kira'; if (!author) author = 'Master';author = author.replace(/[^a-zA-Z0-9]/g, '');	
...
let qqppp = [{
                ...
                sendButLocation(from, teks, `Kyura Master™© | Allright Reserved.`, thumbnail, qqppp, {contextInfo: { mentionedJid: [nupe]}})
